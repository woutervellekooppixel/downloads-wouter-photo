...
export default function LogoTilt() {
  ...
  return (
    <div className="relative mt-20 flex justify-center items-center">
      {showBalloon && (
        <div className="absolute -top-16 bg-white text-black px-4 py-2 rounded shadow animate-fade-in z-10">
          Click to Download
        </div>
      )}
      <div ref={tiltRef} className="w-[300px] h-auto">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2897.5 442.7" className="w-full h-auto">
          <defs>
            <style>
              {`.st0 { fill: #4d4d4d; } .st1 { isolation: isolate; }`}
            </style>
          </defs>
          <g className="st1">
            ...
            <!-- SVG paths truncated for brevity -->
          </g>
        </svg>
      </div>
    </div>
