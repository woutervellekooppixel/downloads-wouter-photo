...
export default async function Page({ params }: PageProps) {
  ...
  const files = await getFilesFromSlug(slug);
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          ...
          >
            ...
            <span className="absolute -bottom-10 left-1/2 -translate-x-1/2 bg-black/80 text-white text-xs px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition duration-500 pointer-events-none">
              Download {slug}.zip
            </span>
          </a>
