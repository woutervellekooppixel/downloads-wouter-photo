...
// ✅ Page functie met support voor submappen en fallback
              ...
              <div key={section.title}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  {section.files.map((file) => (
                    <div key={file.path} className="relative group overflow-hidden rounded shadow">
                      <Image
                        src={file.path}
                        alt={file.name}
                        width={800}
