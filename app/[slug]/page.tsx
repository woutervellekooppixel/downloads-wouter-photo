...
export default function Page({
  ...
  // @ts-expect-error – fs access might be undefined during static build
  const folderPath = path.join(process.cwd(), "public", "photos", slug);

  // @ts-expect-error – fs might not resolve at build time on Vercel
  if (!fs.existsSync(folderPath)) {
    notFound();
  }

  // @ts-expect-error – same reason: file system use in dynamic route
