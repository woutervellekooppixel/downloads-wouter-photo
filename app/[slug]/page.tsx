    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          <div className="relative w-40 h-40 rounded-full bg-white/30 backdrop-blur-md flex items-center justify-center overflow-hidden border-4 border-white animate-spin-slow">
            <a
        ...
        <div className="absolute bottom-4 right-4 text-xs sm:text-sm text-white">
          {slug.replace(/-/g, ' ')} photographed by Wouter Vellekoop
        </div>
      </section>
